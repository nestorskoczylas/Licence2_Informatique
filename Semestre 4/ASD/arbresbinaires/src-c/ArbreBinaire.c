...
void DetruireArbre(Noeud_t racine){
  if (! EstVide(racine)) {
...
void AjouterGauche(Noeud_t racine,Noeud_t noeud){
...
void AjouterDroite(Noeud_t racine,Noeud_t noeud){
...
void RemplacerGauche(Noeud_t racine, Noeud_t noeud){
  racine->gauche = noeud;
}

void RemplacerDroite(Noeud_t racine, Noeud_t noeud){
  racine->droite = noeud;
}

Noeud_t Gauche(Noeud_t n){
  return n->gauche;
}

Noeud_t Droite(Noeud_t n){
  return n->droite;
}
