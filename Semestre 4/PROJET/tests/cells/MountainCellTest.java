...
public class MountainCellTest {
	...
	private MountainCell cell;
	private Unit army;
	private WarPlayer player;

	@Before
	public void before() {
		this.cell = new MountainCell(12, 15, 0, 1, 5, 5);
	...
	public void addandGetUnitOKTest() {
		Cell anotherCell = new MountainCell(1, 1, 0, 1, 5, 5);
	...
	public void isBusyTest() {
		Cell otherCell = new MountainCell(15, 10, 0, 1, 5, 5);
